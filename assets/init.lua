...
-- global ttf fonts
myttf = TTFont.new("fonts/Cabin-Regular-TTF.ttf", 4*8) -- UI
-- HUD
local str = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .:;()?!-+/*"
local myttf2 = TTFont.new("fonts/Cabin-Regular-TTF.ttf", 2*8, str)
local myttf2o = TTFont.new("fonts/Cabin-Regular-TTF.ttf", 2*8, str, 2, 3)
cf2 = CompositeFont.new {
	{ font=myttf2o, color=0x2a2a2a, alpha=1 }, -- draw outline in dark
	{ font=myttf2, x=0, y=0 }, -- draw normal text with an offset
}

-- global ui theme
application:setBackgroundColor(0x363124) -- 0x4d4d4d
g_ui_theme = {}
