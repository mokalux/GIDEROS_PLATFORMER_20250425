...
--[[
	...
	Proto WIP using Gideros framework (what else?).

	Programmer: mokalux 2025 ;-)

	]]
	local tw = TypeWriter.new(cf2, text, 32*8, 3) -- TypeWriter:init(font, text, delay, char)
	tw:setTextColor(math.random(0xffffff)) -- 0x55ff00
...
function Win:myKeysPressed()
	self:addEventListener(Event.KEY_DOWN, function(e)
		...
		-- Menu
		if not alt and e.keyCode == KeyCode.ENTER then self:gotoScene()
		-- switch fullscreen
