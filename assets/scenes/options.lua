...
function Options:init()
	...
	self.mytitle = ButtonMonster.new({
		autoscale=false, pixelwidth=20*8, pixelheight=6*8,
	...
	self.btnMENU = ButtonMonster.new({
		autoscale=false, pixelwidth=18*8, pixelheight=8*8,
		pixelscalexup=0.8, pixelscalexdown=0.9,
		pixelcolorup=g_ui_theme.pixelcolorup, pixelcolordown=g_ui_theme.pixelcolordown,
	...
	-- position
	self.btnLEFT:setPosition(1.5*myappwidth/10+myappleft, 9*8+6*myappheight/10)
	self.btnRIGHT:setPosition(3.5*myappwidth/10+myappleft, 9*8+6*myappheight/10)
	self.btnUP:setPosition(2.5*myappwidth/10+myappleft, 9*8+4.6*myappheight/10)
	self.btnDOWN:setPosition(2.5*myappwidth/10+myappleft, 9*8+7.4*myappheight/10)
	for i = 5, 7 do -- buttons (eg. punch, ...)
		self.btns[i]:setPosition(5.6*myappwidth/10+myappleft, (i-5)*9*8+6*myappheight/10)
	end
