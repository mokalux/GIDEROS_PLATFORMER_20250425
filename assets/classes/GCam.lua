local atan2,sqrt,cos,sin,random = math.atan2,math.sqrt,math.cos,math.sin,math.random
local PI = math.pi
...
function GCam:init(content, ax, ay)
	assert(content ~= stage, "bad argument #1 (Content should be different from the 'stage')")
	...
	self.__debugRMesh:setIndexArray(
		1,3,4, 1,2,4, 1,3,7,
		3,5,7, 2,4,8, 4,8,6,
		5,6,8, 5,8,7, 9,10,11,
		9,11,12, 13,14,15, 13,15,16,
		17,18,19, 17,19,20)
	self.__debugRMesh:setColorArray(
		self.__debugSoftColor,self.__debugAlpha, self.__debugSoftColor,self.__debugAlpha,
		self.__debugSoftColor,self.__debugAlpha, self.__debugSoftColor,self.__debugAlpha,
		self.__debugSoftColor,self.__debugAlpha, self.__debugSoftColor,self.__debugAlpha,
		self.__debugSoftColor,self.__debugAlpha, self.__debugSoftColor,self.__debugAlpha,
		self.__debugAnchorColor,self.__debugAlpha, self.__debugAnchorColor,self.__debugAlpha,
		self.__debugAnchorColor,self.__debugAlpha, self.__debugAnchorColor,self.__debugAlpha,
		self.__debugAnchorColor,self.__debugAlpha, self.__debugAnchorColor,self.__debugAlpha,
		self.__debugAnchorColor,self.__debugAlpha, self.__debugAnchorColor,self.__debugAlpha,
		self.__debugDotColor,self.__debugAlpha, self.__debugDotColor,self.__debugAlpha,
		self.__debugDotColor,self.__debugAlpha, self.__debugDotColor,self.__debugAlpha
	)
...
function GCam:update(dt)
	...
	if obj then 
		...
		if (self.predictMode) then 
			...
			if (self.lockPredX) then self.__predictOffsetX = 0 end
			if (self.lockPredY) then self.__predictOffsetY = 0 end
		end
